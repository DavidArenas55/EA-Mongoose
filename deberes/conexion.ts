...
async function main() {
    ...
    const coche4 = await guardarCoche(coche1) as Coche;
    const coche5 = await guardarCoche(coche2) as Coche ;
    ...
    await obtenerConductorConCoches(conductor1);
